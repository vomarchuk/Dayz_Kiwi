class CraftEmptyBagCanabis extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Створити Зіп-пакетики";
		...
		InsertIngredient(1,"LA_HuntingKnife_sec");
		InsertIngredient(1,"SLC_Katana");
		InsertIngredient(1,"SLC_Tachi");
		InsertIngredient(1,"SLC_Ninjato");
		InsertIngredient(1,"SLC_Wakazashi");
		InsertIngredient(1,"CrudeMachete");
		InsertIngredient(1,"OrientalMachete");
		InsertIngredient(1,"LA_MadeHomeKnife2");
		...
		//result1
		AddResult("CP_EmptyBag");//add results here
