class CFT_CanBoar extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Наповнити банку м’ясом з дикого кабана та герметично закрити її";
