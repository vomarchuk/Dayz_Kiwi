class CFT_CanCow extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Наповнити банку яловичим м’ясом та герметично закрити її";
