class CFT_CanFox extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Наповнити банку м’ясом з лисиці та герметично закрити її";
