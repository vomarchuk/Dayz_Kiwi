class CFT_CanSheep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Наповнити банку баранячим м’ясом та герметично закрити її.";
		m_IsInstaRecipe = false;
		m_AnimationLength = 1;
		m_Specialty = -0.01;
		
	// CowSteakMeat= 448 = 90%; 150 50
